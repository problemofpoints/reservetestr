...
mack_paid_results <- run_single_backtest(cas_db_subset, testr_MackChainLadder, 
...
- create qqplot graphs (summary function to calculate expected percentiles and graph); K-S test, if possible
- add BootChainLadder 
- add GLMReserve
- build deck
